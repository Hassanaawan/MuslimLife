...
class SetBackground extends StatefulWidget {
  const SetBackground({super.key, required this.index});
  final int index;
  @override
...
class _SetBackgroundState extends State<SetBackground> {
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: CachedNetworkImageProvider(provider.allWallpapers![widget.index].thumbnailUrl), fit: BoxFit.cover),
                      ),
  ...
  Widget buildPhotoActions(BuildContext context, largeImage) {
    ...
    var file;
    final provider = Provider.of<WallpaperDataProvider>(context, listen: false);
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          _save(Provider.of<WallpaperDataProvider>(context, listen: false).allWallpapers![widget.index].originalUrl);
                          Navigator.pop(
                              context);
                        },
                        child: Text(
