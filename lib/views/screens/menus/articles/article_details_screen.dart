...
import 'article_details_screen_secondary.dart';

class ArticleDetailsScreen extends StatefulWidget {
  const ArticleDetailsScreen({super.key, required this.title, required this.thumbUrl, required this.timestamp, required this.content, required this.index});
...
class _ArticleDetailsScreenState extends State<ArticleDetailsScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        formatTimestamp2Jan20(widget.timestamp),
  ...
  String formatTimestamp2Jan20(String timestamp) {
    // Convert the timestamp to an integer
    int timestampSeconds = int.parse(timestamp);

    // Convert seconds timestamp to milliseconds (DateTime expects milliseconds)
