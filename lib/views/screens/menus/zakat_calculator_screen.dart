  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
       ...
       Column(
         children: [
           AppBarWidget(screenTitle: "jakat_calculator2".tr,),
           Expanded(
             child: Padding(
    ...
    return DropdownButtonFormField<String>(
      ...
      decoration: const InputDecoration(
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(color: AppColors.colorWhite70, width: 2),
        ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: [AppColors.colorYellowStart,
              AppColors.colorYellowEnd], // Your gradient colors
